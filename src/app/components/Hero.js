...
export default function Hero() {
  return (
    <section className="bg-white flex flex-col items-center justify-center min-h-[50vh] text-center px-6 py-4 pt-2 md:pt-4 lg:pt-6">
      <div className="max-w-5xl w-full px-4 md:px-6 lg:px-8">
        <div className="py-1">

          <h1 className="text-xl text-gray-600 sm:text-2xl md:text-3xl font-bold leading-tight mb-6">
            Welcome to{" "}
            <span className="text-[#27699D]">
              Frontech Services Private Limited
            </span>
          </h1>
          <span className="text-base text-gray-600 sm:text-lg md:text-xl font-medium leading-tight max-w-[70%] mx-auto mb-2">
